...
public enum TrinityToolMaterials implements IItemTier {
	...
	woodbattleaxemat(6.9f, 2.0f, 135, 0, 42, TrinityItems.spear_head_wood),
	goldbattleaxemat(7.4f, 10.0f, 48, 0, 42, TrinityItems.spear_head_gold),
	stonebattleaxemat(7.4f, 4.0f, 147, 0, 42, TrinityItems.spear_head_stone),
	ironbattleaxemat(8.2f, 6.0f, 266, 0, 42, TrinityItems.spear_head_iron),
	diamondbattleaxemat(8.4f, 8.0f, 1577, 0, 42, TrinityItems.spear_head_diamond),
	...
	goldhalberdmat(2f, 1.0f, 40, 0, 42, TrinityItems.halberd_gold),
